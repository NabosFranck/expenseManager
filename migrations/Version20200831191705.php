 ...
 */
final class Version20200831191705 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE comptable (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, UNIQUE INDEX UNIQ_5B644367E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE frais (id INT AUTO_INCREMENT NOT NULL, commercial_id INT DEFAULT NULL, etat TINYINT(1) NOT NULL, trajet DOUBLE PRECISION NOT NULL, nuit DOUBLE PRECISION NOT NULL, repas DOUBLE PRECISION NOT NULL, justificatifs LONGBLOB NOT NULL, justif_name VARCHAR(255) NOT NULL, justif_size INT NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_25404C987854071C (commercial_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
